...
\sop{\mathcal L_0} \dm'(\omega) =  \bbomega\dm'(\omega) + \commutator{\dmnot}{\op\Phi(\omega)}\;.
\ee
...
\left(\bbomega - \sop{\mathcal L}\right) \dm'(\omega) =  \commutator{\op\Phi(\omega)}{\dmnot}\;.
\ee
...
\be
\sket{p\alpha}{\op O}  \equiv \mat{ \trace{ \op O \decay{\alpha}{p}} \\ 
\trace{\op O \excite{p}{\alpha}}} \; .
\ee
