...
%The linear response presented so far is expressed in functions of the fluctuation states. These objects essentially describe the modification of the occupied eigenstates of 
%$\hnot$ induced by the perturbation. They exhibit an explicit dependence on the perturbing field and their $\omega$ dependence is a complicated combination of the intrinsic
%feature of the system  

The linear response presented so far is expressed in functions of the fluctuation states. These objects essentially describe the modification of the occupied eigenstates of 
$\hnot$ induced by the perturbation and, by definition, explicitly depend on the perturbing field. As a consequence, the $\omega$ dependence of fluctuation states is a complicated 
combination of the one of $\op\Phi(\omega)$ and of the intrinsic energetic feature of the system. 

For these reason it is preferable to present an equivalent but alternative formula for the linear response functional \eqref{LinearResponseFunctDef2}...  

%They exhibit an explicit dependence on the perturbing field and their $\omega$ dependence is a complicated combination of the intrinsic
%eature of the system  
