...
\left(\hnot-\eps_p\right)\ket{\phi^E_p} +\sint \dd\alpha  U[\decay{\alpha}{p}; \op E] \ket{\psi(\alpha)} &= E\ket{\phi^E_p} \;,\nn \\
\bra{\chi^E_p}\left(\hnot-\eps_p\right) +\sint \dd\alpha \bra{\psi(\alpha)} U[\excite{p}{\alpha}; \op E] &= -E\bra{\chi^E_p} \;.
\end{align}
...
\begin{align}
\op{\tilde E}\Liouv &= \sum_p\tketbra{\psi_p}{\phi^E_p}\left(\hnot-\eps_p\right) - \sum_p\left(\hnot-\eps_p\right)\tketbra{\chi^E_p}{\psi^E_p} + \nn \\
&+ \sum_p \sint \dd\alpha  U[\commutator{\dmnot}{\op{\tilde E}};\decay{\alpha}{p}] \ketbra{\psi(\alpha)}{\psi_p}
+ \sum_p \sint \dd\alpha U[\commutator{\dmnot}{\op{\tilde E}};\excite{p}{\alpha}] \ketbra{\psi_p}{\psi(\alpha)} = E\op{\tilde E} \;, \nn
\end{align}
