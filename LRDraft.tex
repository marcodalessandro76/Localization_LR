...
\be \lb{ketTimeEvol3} 
\ket{\psi_p(t)} = e^{-\ii \eps_p t}\left( \identity - \ii \intdef{t_0}{t}{t'} \op{U}_0(t-t') \Phi^{a.l,s.l}(t') \op{U}_0(t'-t)  \right)\ket{\psi_p} \; ,
\ee
where we have introduced the \emph{perturbing field operators}: 
\be
\Phi^{a.l.}(t) = e^{-\eta_a |t|} \hone{t} \;, \qq
\Phi^{s.l.}(t) = \theta(t-t_0) \hone{t}
\ee
...
\be\lb{AopDef1}
\op A(t) = \intdef{-\infty}{\infty}{t'} \op{U}^{+}_0(t-t') \Phi^{a.l,s.l}(t') \op{U}^{-}_0(t'-t) \;,
\ee
