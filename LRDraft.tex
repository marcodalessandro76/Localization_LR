...
\begin{align}
 \op{\tilde E} \Liouv &=  \sum_p \sint \dd \alpha \left(\trace{\op{\tilde E}\sop{\mathcal L}\decay{\alpha}{p}} \excite{p}{\alpha} + 
\decay{\alpha}{p} \trace{\op{\tilde E}\Liouv\excite{p}{\alpha}}  \right) = \nn \\
\end{align}
