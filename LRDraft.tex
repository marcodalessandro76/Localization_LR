...
\subsubsection{Spectral decompositionof the response density in the transitions basis}
...
\be\lb{ExctitationOperatorsDef1}
\op E = 
\sum_p \sint \dd \alpha \left(\excite{p}{\alpha} X_E^{p\alpha} + \decay{\alpha}{p} Y_E^{p\alpha}\right) 
\;, \qq
\op{\tilde E} = \sum_p \sint \dd \alpha \left(\decay{\alpha}{p} \tilde X_{E\,p\alpha} + 
...
\begin{align}
\sop{\mathcal L} \op E & = \sum_p \sint \dd \alpha \left(\trace{\decay{\alpha}{p} \sop{\mathcal L} \op E} \excite{p}{\alpha} + 
\decay{\alpha}{p} \trace{ \excite{p}{\alpha} \sop{\mathcal L} \op E}  \right) = \nn \\
...
\begin{align}
 \op{\tilde E} \sop{\mathcal L} &= E \op{\tilde E}
\end{align}
