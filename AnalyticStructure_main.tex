...
Such basis present optimal features of in view of reproducibility of the results,
ans it has proven to represent precisely and explicitly system with Free boundary conditions, without any basis set superposition error nor supercell aliasing.
...
Our LR calculation are performed with the Casida formalism \cite{bhaarathi}, where another parameter is
