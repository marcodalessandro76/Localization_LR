...
% The excitation spectrum is symmetric w.r.t the inversion of the eigenvalues $\Omega_a \rightarrow -\Omega_a$ and we focus our analysis on the sector with positive energy, \emph{i.e.} $\Omega_a>0$. 
% Looking at the coordinate representation 
...
The elements of the first sector correspond to \emph{true poles} of the susceptibility while the others can be interpreted only in terms of the spectral function. 
