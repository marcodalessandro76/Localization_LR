...
\ee
with the normalization condition $\trace{\op E\op E'} = \delta(E-E')$ (WRONG!!!).
%\be
...
\vspace{0.3cm}
\noindent{TODO: Identify the more convenient equations to present the localization argument on the excited states. 
\vspace{0.3cm}

Due to the previous argument we can state that the localization feature of the excited states depend on the energy of the excitation to which they belong. In particular if $E<\eps_p$ the
state $\ket{\phi^E_p}$ behaves as a bound-state  

%defined in the dyadic representation of the excitation operators possess  that 
%state that the excitation spectrum is
