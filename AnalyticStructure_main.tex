...
This analysis evidences that the spectrum of the excitation operators contains two distinct sectors. The first one is composed by a (finite) set of localized excitation with associated discrete 
eigenvalues. Extending the results of \cite{boffi2016} to the equation of motion of \eqref{ExcitationOperatorsDef3} we conclude that the elements of this category behave as \emph{observables} 
quantities and the associated excitation energies have a true physical meaning, independently from the computational setup used for their representation. Conversely, the second sector is made by 
a dense set of delocalized excitations with a continuum spectrum. The elements of this set behaves as the unbound virtual orbitals analyzed in \cite{boffi2016}.... 
...
Excitations are separated into two categories. 
...
obtained through a finite difference method. 
