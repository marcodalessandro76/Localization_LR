...
fluctuation states are complex quantities. Causality implies that the real and imaginary part of the states are related to each othe by the Kramers-Kronig relations}
\be\lb{KKrel}
...
For $\mathrm{Re}\ket{f_p^\Phi(\omega)}$ the situation is slightly more complicated.
For $\omega <$ IP, we know that the entire FS is localized. The equivalence of the Sternheimer formalism with the spectral representation of the LR susceptibility implies that the integral of the Kramers-Kronig
