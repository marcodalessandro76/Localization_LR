...
In this section we review the fundamental equations which govern the behavior of an open quantum system in the linear response regime. Our analysis starts with a brief description of 
the notation adopted in the paper. Then we move on the analysis of the response density and of the excitation operators, with the aim to establish their localization character. 
...
raise to a $f_p(\omega,\r)$ delocalized in the whole accessible space. On the contrary, for values of $\omega$ below the threshold,
