...
of freedom for describe the FS in all the relevant domain. Stated otherwise, to achieve precise results in this regime the 
...
$\dm'(\omega) = \sop \chi(\omega)\op\Phi(\omega)$ and make usage of the dyadic representation ~\eqref{rhoPrimeFluctuationStateDef1} of the response density. Pursuing this procedure provides the excitation-based
