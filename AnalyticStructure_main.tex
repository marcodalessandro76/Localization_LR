...
The argument procedes by splitting the Hamiltonian as the sum of the kinetic $\op T$ and potential $\op V$ term. Since we are dealing with molecular-like systems $\op V$ has a compact support when 
...
\end{align}
where the \emph{excited states} $\ket{\phi^E_p}$, $\bra{\chi^E_p}$ span the empty subspace of $\hnot$. 
