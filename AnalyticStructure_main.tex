...
All the details of the calculations, the \textsl{Jupyter} notebooks of the data analysis, including the ones presented in the Supplementary Information, may be found at the URL~\footnote{\protect\url{https://github.com/luigigenovese/LR-nb/blob/master/POLARIZABILITY/nb_paper/LR_Analysis.ipynb}}
