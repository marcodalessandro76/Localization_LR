...
%We show that the first ionization potential of the system behaves as a threshold energy: for frequencies below this value, it is possible to parametrize the response density by employing localized states only.
We show that for frequencies below the first ionization potential (IP) of the system, it is possible to parametrize the response density by employing localized states only.
