...
\added[id=dal]{This analysis evidences that the description of molecular systems beyond the ground state unavoidably leads to the inclusion of delocalised
degrees of freedom above a specific energetic threshold.}
...
from others that would \emph{explicitly} depend of the employed computational treatment. \added[id=dal]{Moreover on the basis of this analysis we can assess
something about the reliability of the results provided by computational setups able to explicit include the presence of delocalised degrees of freedom compared
to the ones in which these degrees of freedom are excluded by design.}
\deleted[id=dal]{In particular, we will discuss the interplay between reproducible LR quantities and the \emph{locality} of the related objects.}
